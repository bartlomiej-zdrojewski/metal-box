...
document.addEventListener('DOMContentLoaded', function (event) {
    ...
    function validateForm() {
        ...
        const isSurnameValid = validateInputNotEmpty(INPUT_SURNAME_ID);
        const isNameValid = validateInputNotEmpty(INPUT_NAME_ID, isSurnameValid);
    ...
    function register() {
        ...
        fd.append("password_repeat", getInputValue("password_repeat"));
        fd.append("name", getInputValue("name"));
        fd.append("surname", getInputValue("surname"));
